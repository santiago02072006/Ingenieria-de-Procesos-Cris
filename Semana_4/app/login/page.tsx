...
export default async function LoginPage() {
  ...
  return (
    <div className="mx-auto max-w-md px-4 py-20 sm:px-6 lg:px-8">
      <h1 className="text-3xl font-semibold tracking-tight text-zinc-100">Iniciar sesión</h1>
      <p className="mt-2 text-sm text-zinc-400">Accede con tu correo y contraseña de DevSolve.</p>
      <LoginForm />
